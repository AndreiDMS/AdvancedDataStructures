...
Ll.List = function() {
	...
	/**
	 * Retrieve a node by position in the list. Starts from 0. Returns null on
	 * overflow.
	 * 
	 * @param position
	 * @return Ll.Node | null
	...
	/**
	 * Find a node by value. If the node holds objects use the property
	 * parameter to search by object property.
	 * 
	 * @param value
	 * @param property
	 */
